...
namespace MyLeasing.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateToken([FromBody] LoginView model)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> Register(AddUserView model)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ChangeUser(EditUserView model)
        {
            if (ModelState.IsValid)
            {
                var user = await _userHelper.GetUserByEmailAsync(User.Identity.Name);
        ...
        [HttpPost]
        public async Task<IActionResult> RecoverPassword(RecoverPasswordView model)
        {
            if (ModelState.IsValid)
            {
